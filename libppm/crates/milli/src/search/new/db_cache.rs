...
impl<'ctx> SearchContext<'ctx> {
    ...
    pub fn word_docids(
        ...
        self.get_db_word_docids(universe, word.interned())
    }
    ...
    pub fn word_prefix_docids(
        ...
        self.get_db_word_prefix_docids(universe, prefix.interned())
    }
    ...
    pub fn get_db_word_pair_proximity_docids_len(
        ...
        let _ = universe;
        DatabaseCache::get_value_length::<_, _>(
            self.txn,
            (proximity, word1, word2),
            &(
                proximity,
    ...
    pub fn get_db_word_prefix_pair_proximity_docids(
            ...
            self.db_cache.word_prefix_pair_proximity_docids.get(&(proximity, word1, prefix2))
        {
            ...
            // Compute docids using a prefix iterator and store the result in the cache.
